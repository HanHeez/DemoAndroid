package com.gtv.hanhee.customview.View;
...
import com.gtv.hanhee.customview.Interface.IndicatorInterface;
import com.gtv.hanhee.customview.Interface.PageLessException;
import com.gtv.hanhee.customview.R;
...
public class IndicatorView extends View implements IndicatorInterface, ViewPager.OnPageChangeListener {
    ...
    // khởi tạo các giá trị của custom view
    public IndicatorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.IndicatorView);
        this.radiusSelected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_iv_radius_selected, DEFAULT_RADIUS_SELECTED);
        this.radiusUnselected = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_iv_radius_unselected, DEFAULT_RADIUS_UNSELECTED);
        this.distance = typedArray.getInt(R.styleable.IndicatorView_iv_distance, DEFAULT_DISTANCE);
        this.colorSelected = typedArray.getColor(R.styleable.IndicatorView_iv_color_selected, Color.parseColor("#ffffff"));
        this.colorUnselected = typedArray.getColor(R.styleable.IndicatorView_iv_color_unselected, Color.parseColor("#ffffff"));
        typedArray.recycle();
    }
