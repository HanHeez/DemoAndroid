...
public class QuanAnModel implements Parcelable {
    ...
    public QuanAnModel(Parcel in) {
        ...
        binhluanlist = new ArrayList<BinhLuanModel>();
        in.readTypedList(binhluanlist, BinhLuanModel.CREATOR);
    ...
    public List<BinhLuanModel> getBinhluanlist() {
        return binhluanlist;
    }

    public void setBinhluanlist(List<BinhLuanModel> binhluanlist) {
